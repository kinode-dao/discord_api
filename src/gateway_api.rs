...
pub fn parse_gateway_blob(payload_bytes: &[u8]) -> anyhow::Result<(GatewayReceiveEvent, Option<u64>)> {
  ...
  let payload: GatewayReceiveEvent = match t {
      GatewayEventType::Ready => {
        let data = match serde_json::from_value::<Ready>(payload.d.clone()) {
          Ok(data) => data,
          Err(_) => {
            return Err(anyhow::anyhow!("Failed to parse {} event with data: {}", "Ready", payload.d.to_string()))
          }
        };
      ...
      GatewayEventType::ApplicationCommandPermissionsUpdate => {
        let data = match serde_json::from_value::<ApplicationCommandPermissionsUpdate>(payload.d.clone()) {
          Ok(data) => data,
          Err(_) => {
            return Err(anyhow::anyhow!("Failed to parse {} event with data: {}", "ApplicationCommandPermissionsUpdate", payload.d.to_string()))
          }
        };
      ...
      GatewayEventType::AutoModerationRuleCreate => {
        let data = match serde_json::from_value::<AutoModerationRuleCreate>(payload.d.clone()) {
          Ok(data) => data,
          Err(_) => {
            return Err(anyhow::anyhow!("Failed to parse {} event with data: {}", "AutoModerationRuleCreate", payload.d.to_string()))
          }
        };
      ...
      GatewayEventType::AutoModerationRuleUpdate => {
        let data = match serde_json::from_value::<AutoModerationRuleUpdate>(payload.d.clone()) {
          Ok(data) => data,
          Err(_) => {
            return Err(anyhow::anyhow!("Failed to parse {} event with data: {}", "AutoModerationRuleUpdate", payload.d.to_string()))
          }
        };
      ...
      GatewayEventType::AutoModerationRuleDelete => {
        let data = match serde_json::from_value::<AutoModerationRuleDelete>(payload.d.clone()) {
          Ok(data) => data,
          Err(_) => {
            return Err(anyhow::anyhow!("Failed to parse {} event with data: {}", "AutoModerationRuleDelete", payload.d.to_string()))
          }
        };
        GatewayReceiveEvent::AutoModerationRuleDelete(data)
      }
      GatewayEventType::AutoModerationActionExecution => {
        let data = match serde_json::from_value::<AutoModerationActionExecution>(payload.d.clone()) {
          Ok(data) => data,
          Err(_) => {
            return Err(anyhow::anyhow!("Failed to parse {} event with data: {}", "AutoModerationActionExecution", payload.d.to_string()))
          }
        };
      ...
      GatewayEventType::ChannelCreate => {
        let data = match serde_json::from_value::<Channel>(payload.d.clone()) {
          Ok(data) => data,
          Err(_) => {
            return Err(anyhow::anyhow!("Failed to parse {} event with data: {}", "ChannelCreate", payload.d.to_string()))
          }
        };
      ...
      GatewayEventType::ChannelUpdate => {
        let data = match serde_json::from_value::<Channel>(payload.d.clone()) {
          Ok(data) => data,
          Err(_) => {
            return Err(anyhow::anyhow!("Failed to parse {} event with data: {}", "ChannelUpdate", payload.d.to_string()))
          }
        };
      ...
      GatewayEventType::ChannelDelete => {
        let data = match serde_json::from_value::<Channel>(payload.d.clone()) {
          Ok(data) => data,
          Err(_) => {
            return Err(anyhow::anyhow!("Failed to parse {} event with data: {}", "ChannelDelete", payload.d.to_string()))
          }
        };
      ...
      GatewayEventType::ChannelPinsUpdate => {
        let data = match serde_json::from_value::<ChannelPinsUpdate>(payload.d.clone()) {
          Ok(data) => data,
          Err(_) => {
            return Err(anyhow::anyhow!("Failed to parse {} event with data: {}", "ChannelPinsUpdate", payload.d.to_string()))
          }
        };
      ...
      GatewayEventType::ThreadCreate => {
        let data = match serde_json::from_value::<Channel>(payload.d.clone()) {
          Ok(data) => data,
          Err(_) => {
            return Err(anyhow::anyhow!("Failed to parse {} event with data: {}", "ThreadCreate", payload.d.to_string()))
          }
        };
      ...
      GatewayEventType::ThreadUpdate => {
        let data = match serde_json::from_value::<Channel>(payload.d.clone()) {
          Ok(data) => data,
          Err(_) => {
            return Err(anyhow::anyhow!("Failed to parse {} event with data: {}", "ThreadUpdate", payload.d.to_string()))
          }
        };
      ...
      GatewayEventType::ThreadDelete => {
        let data = match serde_json::from_value::<ThreadDelete>(payload.d.clone()) {
          Ok(data) => data,
          Err(_) => {
            return Err(anyhow::anyhow!("Failed to parse {} event with data: {}", "ThreadDelete", payload.d.to_string()))
          }
        };
      ...
      GatewayEventType::ThreadListSync => {
        let data = match serde_json::from_value::<ThreadListSync>(payload.d.clone()) {
          Ok(data) => data,
          Err(_) => {
            return Err(anyhow::anyhow!("Failed to parse {} event with data: {}", "ThreadListSync", payload.d.to_string()))
          }
        };
      ...
      GatewayEventType::ThreadMemberUpdate => {
        let data = match serde_json::from_value::<ThreadMember>(payload.d.clone()) {
          Ok(data) => data,
          Err(_) => {
            return Err(anyhow::anyhow!("Failed to parse {} event with data: {}", "ThreadMemberUpdate", payload.d.to_string()))
          }
        };
      ...
      GatewayEventType::ThreadMembersUpdate => {
        let data = match serde_json::from_value::<ThreadMembersUpdate>(payload.d.clone()) {
          Ok(data) => data,
          Err(_) => {
            return Err(anyhow::anyhow!("Failed to parse {} event with data: {}", "ThreadMembersUpdate", payload.d.to_string()))
          }
        };
      ...
      GatewayEventType::EntitlementCreate => {
        let data = match serde_json::from_value::<Entitlement>(payload.d.clone()) {
          Ok(data) => data,
          Err(_) => {
            return Err(anyhow::anyhow!("Failed to parse {} event with data: {}", "EntitlementCreate", payload.d.to_string()))
          }
        };
      ...
      GatewayEventType::EntitlementUpdate => {
        let data = match serde_json::from_value::<Entitlement>(payload.d.clone()) {
          Ok(data) => data,
          Err(_) => {
            return Err(anyhow::anyhow!("Failed to parse {} event with data: {}", "EntitlementUpdate", payload.d.to_string()))
          }
        };
      ...
      GatewayEventType::EntitlementDelete => {
        let data = match serde_json::from_value::<Entitlement>(payload.d.clone()) {
          Ok(data) => data,
          Err(_) => {
            return Err(anyhow::anyhow!("Failed to parse {} event with data: {}", "EntitlementDelete", payload.d.to_string()))
          }
        };
      ...
      GatewayEventType::GuildCreate => {
        let data = match serde_json::from_value::<Guild>(payload.d.clone()) {
          ...
          Err(_) => {
            match serde_json::from_value::<UnavailableGuild>(payload.d.clone()) {
              Ok(data) => (None, Some(data)),
              Err(_) => {
                return Err(anyhow::anyhow!("Failed to parse {} event with data: {}", "GuildCreate", payload.d.to_string()))
              }
            }
          }
        };
      ...
      GatewayEventType::GuildUpdate => {
        let data = match serde_json::from_value::<Guild>(payload.d.clone()) {
          Ok(data) => data,
          Err(_) => {
            return Err(anyhow::anyhow!("Failed to parse {} event with data: {}", "GuildUpdate", payload.d.to_string()))
          }
        };
      ...
      GatewayEventType::GuildDelete => {
        let data = match serde_json::from_value::<UnavailableGuild>(payload.d.clone()) {
          Ok(data) => data,
          Err(_) => {
            return Err(anyhow::anyhow!("Failed to parse {} event with data: {}", "GuildDelete", payload.d.to_string()))
          }
        };
      ...
      GatewayEventType::GuildAuditLogEntryCreate => {
        let data = match serde_json::from_value::<AuditLogEntry>(payload.d.clone()) {
          Ok(data) => data,
          Err(_) => {
            return Err(anyhow::anyhow!("Failed to parse {} event with data: {}", "GuildAuditLogEntryCreate", payload.d.to_string()))
          }
        };
      ...
      GatewayEventType::GuildBanAdd => {
        let data = match serde_json::from_value::<GuildBanAdd>(payload.d.clone()) {
          Ok(data) => data,
          Err(_) => {
            return Err(anyhow::anyhow!("Failed to parse {} event with data: {}", "GuildBanAdd", payload.d.to_string()))
          }
        };
      ...
      GatewayEventType::GuildBanRemove => {
        let data = match serde_json::from_value::<GuildBanRemove>(payload.d.clone()) {
          Ok(data) => data,
          Err(_) => {
            return Err(anyhow::anyhow!("Failed to parse {} event with data: {}", "GuildBanRemove", payload.d.to_string()))
          }
        };
      ...
      GatewayEventType::GuildEmojisUpdate => {
        let data = match serde_json::from_value::<GuildEmojisUpdate>(payload.d.clone()) {
          Ok(data) => data,
          Err(_) => {
            return Err(anyhow::anyhow!("Failed to parse {} event with data: {}", "GuildEmojisUpdate", payload.d.to_string()))
          }
        };
      ...
      GatewayEventType::GuildStickersUpdate => {
        let data = match serde_json::from_value::<GuildStickersUpdate>(payload.d.clone()) {
          Ok(data) => data,
          Err(_) => {
            return Err(anyhow::anyhow!("Failed to parse {} event with data: {}", "GuildStickersUpdate", payload.d.to_string()))
          }
        };
      ...
      GatewayEventType::GuildIntegrationsUpdate => {
        let data = match serde_json::from_value::<GuildIntegrationsUpdate>(payload.d.clone()) {
          Ok(data) => data,
          Err(_) => {
            return Err(anyhow::anyhow!("Failed to parse {} event with data: {}", "GuildIntegrationsUpdate", payload.d.to_string()))
          }
        };
      ...
      GatewayEventType::GuildMemberAdd => {
        let data = match serde_json::from_value::<GuildMember>(payload.d.clone()) {
          Ok(data) => data,
          Err(_) => {
            return Err(anyhow::anyhow!("Failed to parse {} event with data: {}", "GuildMemberAdd", payload.d.to_string()))
          }
        };
      ...
      GatewayEventType::GuildMemberRemove => {
        let data = match serde_json::from_value::<GuildMemberRemove>(payload.d.clone()) {
          Ok(data) => data,
          Err(_) => {
            return Err(anyhow::anyhow!("Failed to parse {} event with data: {}", "GuildMemberRemove", payload.d.to_string()))
          }
        };
      ...
      GatewayEventType::GuildMemberUpdate => {
        let data = match serde_json::from_value::<GuildMemberUpdate>(payload.d.clone()) {
          Ok(data) => data,
          Err(_) => {
            return Err(anyhow::anyhow!("Failed to parse {} event with data: {}", "GuildMemberUpdate", payload.d.to_string()))
          }
        };
      ...
      GatewayEventType::GuildMembersChunk => {
        let data = match serde_json::from_value::<GuildMembersChunk>(payload.d.clone()) {
          Ok(data) => data,
          Err(_) => {
            return Err(anyhow::anyhow!("Failed to parse {} event with data: {}", "GuildMembersChunk", payload.d.to_string()))
          }
        };
      ...
      GatewayEventType::GuildRoleCreate => {
        let data = match serde_json::from_value::<GuildRoleCreate>(payload.d.clone()) {
          Ok(data) => data,
          Err(_) => {
            return Err(anyhow::anyhow!("Failed to parse {} event with data: {}", "GuildRoleCreate", payload.d.to_string()))
          }
        };
      ...
      GatewayEventType::GuildRoleUpdate => {
        let data = match serde_json::from_value::<GuildRoleUpdate>(payload.d.clone()) {
          Ok(data) => data,
          Err(_) => {
            return Err(anyhow::anyhow!("Failed to parse {} event with data: {}", "GuildRoleUpdate", payload.d.to_string()))
          }
        };
      ...
      GatewayEventType::GuildRoleDelete => {
        let data = match serde_json::from_value::<GuildRoleDelete>(payload.d.clone()) {
          Ok(data) => data,
          Err(_) => {
            return Err(anyhow::anyhow!("Failed to parse {} event with data: {}", "GuildRoleDelete", payload.d.to_string()))
          }
        };
      ...
      GatewayEventType::GuildScheduledEventCreate => {
        let data = match serde_json::from_value::<GuildScheduledEvent>(payload.d.clone()) {
          Ok(data) => data,
          Err(_) => {
            return Err(anyhow::anyhow!("Failed to parse {} event with data: {}", "GuildScheduledEventCreate", payload.d.to_string()))
          }
        };
      ...
      GatewayEventType::GuildScheduledEventUpdate => {
        let data = match serde_json::from_value::<GuildScheduledEvent>(payload.d.clone()) {
          Ok(data) => data,
          Err(_) => {
            return Err(anyhow::anyhow!("Failed to parse {} event with data: {}", "GuildScheduledEventUpdate", payload.d.to_string()))
          }
        };
      ...
      GatewayEventType::GuildScheduledEventDelete => {
        let data = match serde_json::from_value::<GuildScheduledEvent>(payload.d.clone()) {
          Ok(data) => data,
          Err(_) => {
            return Err(anyhow::anyhow!("Failed to parse {} event with data: {}", "GuildScheduledEventDelete", payload.d.to_string()))
          }
        };
      ...
      GatewayEventType::GuildScheduledEventUserAdd => {
        let data = match serde_json::from_value::<GuildScheduledEventUser>(payload.d.clone()) {
          Ok(data) => data,
          Err(_) => {
            return Err(anyhow::anyhow!("Failed to parse {} event with data: {}", "GuildScheduledEventUserAdd", payload.d.to_string()))
          }
        };
      ...
      GatewayEventType::GuildScheduledEventUserRemove => {
        let data = match serde_json::from_value::<GuildScheduledEventUser>(payload.d.clone()) {
          Ok(data) => data,
          Err(_) => {
            return Err(anyhow::anyhow!("Failed to parse {} event with data: {}", "GuildScheduledEventUserRemove", payload.d.to_string()))
          }
        };
      ...
      GatewayEventType::IntegrationCreate => {
        let data = match serde_json::from_value::<Integration>(payload.d.clone()) {
          Ok(data) => data,
          Err(_) => {
            return Err(anyhow::anyhow!("Failed to parse {} event with data: {}", "IntegrationCreate", payload.d.to_string()))
          }
        };
      ...
      GatewayEventType::IntegrationUpdate => {
        let data = match serde_json::from_value::<Integration>(payload.d.clone()) {
          Ok(data) => data,
          Err(_) => {
            return Err(anyhow::anyhow!("Failed to parse {} event with data: {}", "IntegrationUpdate", payload.d.to_string()))
          }
        };
      ...
      GatewayEventType::IntegrationDelete => {
        let data = match serde_json::from_value::<IntegrationDelete>(payload.d.clone()) {
          Ok(data) => data,
          Err(_) => {
            return Err(anyhow::anyhow!("Failed to parse {} event with data: {}", "IntegrationDelete", payload.d.to_string()))
          }
        };
      ...
      GatewayEventType::InteractionCreate => {
        let data = match serde_json::from_value::<Interaction>(payload.d.clone()) {
          Ok(data) => data,
          Err(_) => {
            return Err(anyhow::anyhow!("Failed to parse {} event with data: {}", "InteractionCreate", payload.d.to_string()))
          }
        };
      ...
      GatewayEventType::InviteCreate => {
        let data = match serde_json::from_value::<InviteCreate>(payload.d.clone()) {
          Ok(data) => data,
          Err(_) => {
            return Err(anyhow::anyhow!("Failed to parse {} event with data: {}", "InviteCreate", payload.d.to_string()))
          }
        };
      ...
      GatewayEventType::InviteDelete => {
        let data = match serde_json::from_value::<InviteDelete>(payload.d.clone()) {
          Ok(data) => data,
          Err(_) => {
            return Err(anyhow::anyhow!("Failed to parse {} event with data: {}", "InviteDelete", payload.d.to_string()))
          }
        };
      ...
      GatewayEventType::MessageCreate => {
        let data = match serde_json::from_value::<Message>(payload.d.clone()) {
          Ok(data) => data,
          Err(_) => {
            return Err(anyhow::anyhow!("Failed to parse {} event with data: {}", "MessageCreate", payload.d.to_string()))
          }
        };
      ...
      GatewayEventType::MessageUpdate => {
        let data = match serde_json::from_value::<Message>(payload.d.clone()) {
          Ok(data) => data,
          Err(_) => {
            return Err(anyhow::anyhow!("Failed to parse {} event with data: {}", "MessageUpdate", payload.d.to_string()))
          }
        };
      ...
      GatewayEventType::MessageDelete => {
        let data = match serde_json::from_value::<MessageDelete>(payload.d.clone()) {
          Ok(data) => data,
          Err(_) => {
            return Err(anyhow::anyhow!("Failed to parse {} event with data: {}", "MessageDelete", payload.d.to_string()))
          }
        };
      ...
      GatewayEventType::MessageDeleteBulk => {
        let data = match serde_json::from_value::<MessageDeleteBulk>(payload.d.clone()) {
          Ok(data) => data,
          Err(_) => {
            return Err(anyhow::anyhow!("Failed to parse {} event with data: {}", "MessageDeleteBulk", payload.d.to_string()))
          }
        };
      ...
      GatewayEventType::MessageReactionAdd => {
        let data = match serde_json::from_value::<MessageReactionAdd>(payload.d.clone()) {
          Ok(data) => data,
          Err(_) => {
            return Err(anyhow::anyhow!("Failed to parse {} event with data: {}", "MessageReactionAdd", payload.d.to_string()))
          }
        };
      ...
      GatewayEventType::MessageReactionRemove => {
        let data = match serde_json::from_value::<MessageReactionRemove>(payload.d.clone()) {
          Ok(data) => data,
          Err(_) => {
            return Err(anyhow::anyhow!("Failed to parse {} event with data: {}", "MessageReactionRemove", payload.d.to_string()))
          }
        };
      ...
      GatewayEventType::MessageReactionRemoveAll => {
        let data = match serde_json::from_value::<MessageReactionRemoveAll>(payload.d.clone()) {
          Ok(data) => data,
          Err(_) => {
            return Err(anyhow::anyhow!("Failed to parse {} event with data: {}", "MessageReactionRemoveAll", payload.d.to_string()))
          }
        };
      ...
      GatewayEventType::MessageReactionRemoveEmoji => {
        let data = match serde_json::from_value::<MessageReactionRemoveEmoji>(payload.d.clone()) {
          Ok(data) => data,
          Err(_) => {
            return Err(anyhow::anyhow!("Failed to parse {} event with data: {}", "MessageReactionRemoveEmoji", payload.d.to_string()))
          }
        };
      ...
      GatewayEventType::PresenceUpdate => {
        let data = match serde_json::from_value::<PresenceUpdate>(payload.d.clone()) {
          Ok(data) => data,
          Err(_) => {
            return Err(anyhow::anyhow!("Failed to parse {} event with data: {}", "PresenceUpdate", payload.d.to_string()))
          }
        };
      ...
      GatewayEventType::StageInstanceCreate => {
        let data = match serde_json::from_value::<StageInstance>(payload.d.clone()) {
          Ok(data) => data,
          Err(_) => {
            return Err(anyhow::anyhow!("Failed to parse {} event with data: {}", "StageInstanceCreate", payload.d.to_string()))
          }
        };
      ...
      GatewayEventType::StageInstanceUpdate => {
        let data = match serde_json::from_value::<StageInstance>(payload.d.clone()) {
          Ok(data) => data,
          Err(_) => {
            return Err(anyhow::anyhow!("Failed to parse {} event with data: {}", "StageInstanceUpdate", payload.d.to_string()))
          }
        };
      ...
      GatewayEventType::StageInstanceDelete => {
        let data = match serde_json::from_value::<StageInstance>(payload.d.clone()) {
          Ok(data) => data,
          Err(_) => {
            return Err(anyhow::anyhow!("Failed to parse {} event with data: {}", "StageInstanceDelete", payload.d.to_string()))
          }
        };
      ...
      GatewayEventType::TypingStart => {
        let data = match serde_json::from_value::<TypingStart>(payload.d.clone()) {
          Ok(data) => data,
          Err(_) => {
            return Err(anyhow::anyhow!("Failed to parse {} event with data: {}", "TypingStart", payload.d.to_string()))
          }
        };
      ...
      GatewayEventType::UserUpdate => {
        let data = match serde_json::from_value::<User>(payload.d.clone()) {
          Ok(data) => data,
          Err(_) => {
            return Err(anyhow::anyhow!("Failed to parse {} event with data: {}", "UserUpdate", payload.d.to_string()))
          }
        };
      ...
      GatewayEventType::VoiceStateUpdate => {
        let data = match serde_json::from_value::<VoiceState>(payload.d.clone()) {
          Ok(data) => data,
          Err(_) => {
            return Err(anyhow::anyhow!("Failed to parse {} event with data: {}", "VoiceStateUpdate", payload.d.to_string()))
          }
        };
      ...
      GatewayEventType::VoiceServerUpdate => {
        let data = match serde_json::from_value::<VoiceServerUpdate>(payload.d.clone()) {
          Ok(data) => data,
          Err(_) => {
            return Err(anyhow::anyhow!("Failed to parse {} event with data: {}", "VoiceServerUpdate", payload.d.to_string()))
          }
        };
      ...
      GatewayEventType::WebhooksUpdate => {
        let data = match serde_json::from_value::<WebhooksUpdate>(payload.d.clone()) {
          Ok(data) => data,
          Err(_) => {
            return Err(anyhow::anyhow!("Failed to parse {} event with data: {}", "WebhooksUpdate", payload.d.to_string()))
          }
        };
